...
edit('building-jarvis', [
  ['personal vision opening', /<p>When people ask what I'm building at [^,<]+,[\s\S]*?<p>But the simpler answer is: we're building Jarvis\.<\/p>/, `<p>When people ask what kind of personal AI I want to build, I can give the technical answer: small models, long-term memory pipelines, and local inference.</p>
...
edit('cheap-then-clean', [
  ['public technique framing', /<p>Here's how we approach it at [^:<]+:<\/p>/, `<p>The public technique is a two-pass pipeline:</p>`],
...
edit('embodied-ai', [
  ...
  ['timeline speculation', /The pieces are coming together\. We're 5-10 years from this being\s*mainstream\./, 'The ingredients are coming together, but the adoption timeline is uncertain.'],
